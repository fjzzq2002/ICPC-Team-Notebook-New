...
\section{Network flow}
	...
	\kactlimport{MinCostFlowAnton.cpp}
	\kactlimport{Dinic.cpp}
	\kactlimport{DinicAnton.cpp}
	\kactlimport{MinCut.h}
	\kactlimport{GlobalMinCut.h} % seems better than StoerWagner.cpp
	\kactlimport{GomoryHu.h}

\section{Matching}
	\kactlimport{Blossom.cpp}
	\kactlimport{MaximumMatchingRandom.cpp}
	...
	\kactlimport{MinimumAverageCycle.cpp}
...
\section{DFS algorithms}
	...
	% \kactlimport{2sat.h}
	\kactlimport{EulerWalk.h} % seems better than EulerTour.cpp

\section{Coloring}
	\kactlimport{ChordalGraphOrder.cpp}
...
\section{Trees}
	...
	\kactlimport{DirectedMST.h} % seems better than Edmonds.cpp
